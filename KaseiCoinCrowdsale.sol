...
contract KaseiCoinCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale, 
            TimedCrowdsale, RefundablePostDeliveryCrowdsale { // UPDATE THE CONTRACT SIGNATURE TO ADD INHERITANCE
    
    // Provide parameters for all of the features of your crowdsale, such as the `rate`, `wallet` for fundraising, and `token`.
    constructor(
        uint256 rate, // rate TKNbits
...
contract KaseiCoinCrowdsaleDeployer {
    ...
    constructor(
       ...
       uint goal
        ...
        //KaseiCoinCrowdsale kaseiCrowdsale = new KaseiCoinCrowdsale(1, wallet, token, goal, now, now + 10 minutes );
        KaseiCoinCrowdsale kaseiCrowdsale = new KaseiCoinCrowdsale (1, wallet, token, goal, now, now + 5 minutes);    
